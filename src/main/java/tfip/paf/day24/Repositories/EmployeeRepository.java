...
public class EmployeeRepository {
    ...
    public List<Employee> findAll() {
        ResponseEntity<List<Employee>> result = restTemplate.exchange(GET_EMPLOYEES_ENDPOINT_URL, HttpMethod.GET,null,new ParameterizedTypeReference<List<Employee>>() { 
        });
    ...
    public Boolean save(Employee employee) {
        Boolean saved = restTemplate.postForObject(CREATE_EMPLOYEE_ENDPOINT_URL, employee, Boolean.class);
        return saved;
    }
